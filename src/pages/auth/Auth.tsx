    ...
    <div className={styles.authPage}>
      ...
      <main>
        <div className={styles.chat}>
          <SentMessage title={'Войдите или зарегистрируйтесь'} extra={'чтобы пользоваться сервисом на любом устройстве'} />
          {authProgress === 5 && (
            ...
            <input type="text" name="password" value={passwordValue} onChange={event => setPasswordValue(event.target.value)} placeholder="Пароль"/>
              </div>
            ...
            <button disabled={isButtonDisabled}>Продолжить</button>
            <div className={styles.rules}>
              <p>Нажимая «Продолжить», я соглашаюсь</p>
              <p>с <span>Политикой конфиденциальности</span></p>
              <p>и <span>Пользовательским соглашением</span></p>
            </div>
          </div>
          )}
        </div>
